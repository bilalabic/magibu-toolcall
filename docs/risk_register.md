...
| Near duplicates with entity swaps | Inflated diversity | entity-placeholder normalized hash plus OpenAI embedding scan | Tune and approve the model/threshold with pilot evidence |
...
| Fixture mistaken for live provider data | Scope/reporting error | explicit execution type, fixture IDs, provenance notes, and candidate lifecycle | Keep fixtures out of training text and distinguish synthetic data from approved snapshots |
